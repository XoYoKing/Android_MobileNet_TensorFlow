...
python retrain.py --image_dir tpv/input/ --how_many_training_steps=1000 --architecture mobilenet_1.0_224 --output_labels %diroutput%labels.txt --output_graph %diroutput%graph.pb
pause