...
cd %dirwork%
E:
set diroutput=noodles/output/%DateTime%_noodles_
python retrain.py --image_dir noodles/input/ --how_many_training_steps=50 --architecture mobilenet_1.0_224 --output_labels %diroutput%labels.txt --output_graph %diroutput%graph.pb
pause